  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <SectionCard className="p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <span className="text-lg font-bold text-blue-600">{insights.avgTimeToHire} days</span>
              </div>
            ...
            <div className="space-y-3">
              {insights.recommendations.map((rec, i) => (
                <div key={i} className="flex items-start space-x-3 p-3 bg-green-50 rounded-lg">
                  <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0 status-dot status-dot-online"></div>
      ...
      <div>
        ...
        {/* Getting Started */}
        <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-2xl p-12 text-center border border-blue-100 relative overflow-hidden">
          ...
          <div className="relative max-w-3xl mx-auto">
            <div className="inline-flex items-center px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full text-sm font-medium mb-6">
              <div className="w-2 h-2 bg-blue-500 rounded-full mr-2 animate-pulse" aria-hidden="true"></div>
              Powered by I Knowledge Factory Pvt. Ltd
            </div>
            <h3 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4 text-balance">
              Ready to revolutionize your hiring process?
            </h3>
            <p className="text-base md:text-lg text-gray-600 mb-8 max-w-2xl mx-auto text-balance">
              Join thousands of companies using our AI-powered platform to find the perfect candidates faster and more efficiently.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                to="/jobs" 
              ...
              <Link 
                to="/candidates" 
                className="btn btn-secondary btn-lg shadow-lg hover:shadow-xl"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                </svg>
